      ...
      <article className="container mx-auto px-6 max-w-3xl">
        ...
        <section className="mt-12 bg-navy-900 text-white p-8 rounded-xl">
          ...
          <p className="text-gray-300 mb-6 leading-relaxed">
            A {CONSULTATION.DURATION_MIN}-minute assessment is {CONSULTATION.FEE_KRW_LABEL}{' '}
            ({CONSULTATION.FEE_USD_APPROX_LABEL}), VAT included — the same fee in Korean or English,
            conducted by the attorney who would handle your case.
          </p>
